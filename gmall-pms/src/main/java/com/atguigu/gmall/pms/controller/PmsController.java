...
public class PmsController {
    String accessId = "LTAI4G115rvv7359GNAX2cvC"; // 请填写您的AccessKeyId。
    String accessKey = "xlgGCR4euMCi7VySqpNW4V4cFPVsPX"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "ywl-ggmall"; // 请填写您的 bucketname 。
